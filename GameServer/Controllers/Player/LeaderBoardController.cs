...
namespace GameServer.Controllers.Player
{
    public class LeaderBoardController : Controller
    {
        ...
        {
            return Content(LeaderBoards.ViewSubLeaderBoard(database, Request.Cookies["username"], sub_group_id, 
        ...
        {
            return Content(LeaderBoards.ViewSubLeaderBoardAroundMe(database, Request.Cookies["username"], sub_group_id, sub_key_id, type, platform, 
