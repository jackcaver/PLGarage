...
{
    /// <inheritdoc />
    public partial class RemoveGamesFromDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameTable(
                name: "OnlineRaces",
                newName: "OnlineRacesStarted");

            migrationBuilder.RenameIndex(
                name: "IX_OnlineRaces_PlayerId",
                table: "OnlineRacesStarted",
                newName: "IX_OnlineRacesStarted_PlayerId");
            ...
            migrationBuilder.AddPrimaryKey(
                name: "PK_OnlineRacesStarted",
                table: "OnlineRacesStarted",
                column: "Id");

            migrationBuilder.AddForeignKey(
                name: "FK_OnlineRacesStarted_Users_PlayerId",
                table: "OnlineRacesStarted",
                column: "PlayerId",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameTable(
                name: "OnlineRacesStarted",
                newName: "OnlineRaces");

            migrationBuilder.RenameIndex(
                name: "IX_OnlineRacesStarted_PlayerId",
                table: "OnlineRaces",
                newName: "IX_OnlineRaces_PlayerId");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberLaps = table.Column<int>(type: "int", nullable: false),
                    Platform = table.Column<int>(type: "int", nullable: false),
                    Privacy = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SpeedClass = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Track = table.Column<int>(type: "int", nullable: false),
                    TrackGroup = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CharacterIdx = table.Column<int>(type: "int", nullable: false),
                    ...
                    LocationTag = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    MusicIdx = table.Column<int>(type: "int", nullable: false),
                    ...
                    TrackIdx = table.Column<int>(type: "int", nullable: false),
                    TrackPlatform = table.Column<int>(type: "int", nullable: false),
