...
{
    // TODO: Replace ALL of the below that are functions (this may look pretty, but is horrid for optimisation and is likely the cause of a large portion of the sluggishness)
    public class User
    {
        ...
        public ICollection<PlayerCreationData> PlayerCreations { get; set; }
        public ICollection<PlayerPoint> PlayerPoints { get; set; }
        public ICollection<PlayerCreationPoint> PlayerCreationPoints { get; set; }
        public ICollection<PlayerExperiencePoint> PlayerExperiencePoints { get; set; }
