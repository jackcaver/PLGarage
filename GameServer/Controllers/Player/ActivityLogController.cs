...
namespace GameServer.Controllers.Player
{
    public class ActivityLogController : Controller
    {
        ...
        public IActionResult NewsFeedTally()
        {
            ...
            return Content(ActivityLogImpl.NewsFeedTally(database, SessionID), "application/xml;charset=utf-8");
        }
        ...
        public IActionResult NewsFeed(int page, int per_page)
        {
            ...
            if (Request.Cookies.ContainsKey("session_id"))
                SessionID = Guid.Parse(Request.Cookies["session_id"]);
            return Content(ActivityLogImpl.GetActivityLog(database, SessionID, page, per_page), "application/xml;charset=utf-8");
        }
        ...
        public IActionResult GetActivityLog(int page, int per_page, int? player_id)
        {
            ...
            if (Request.Cookies.ContainsKey("session_id"))
                SessionID = Guid.Parse(Request.Cookies["session_id"]);
            return Content(ActivityLogImpl.GetActivityLog(database, SessionID, page, per_page, ActivityList.activity_log, player_id), "application/xml;charset=utf-8");
        }
        ...
        public IActionResult TrackFeed(int? player_creation_id, int page, int per_page)
        {
            ...
            if (Request.Cookies.ContainsKey("session_id"))
                SessionID = Guid.Parse(Request.Cookies["session_id"]);
            return Content(ActivityLogImpl.GetActivityLog(database, SessionID, page, per_page, ActivityList.activity_log, null, player_creation_id), "application/xml;charset=utf-8");
        }
        ...
        public IActionResult CreateEvent(string topic, ActivityList list_name, int creator_id, PlayerEvent @event)
        {
            ...
            return Content(ActivityLogImpl.CreateEvent(database, SessionID, activityType, creator_id, @event, list_name), "application/xml;charset=utf-8");
        }
